    ...
    if coll == "orders" {
        vec![
            SchemaField {
                name: "_id".into(),
                depth: 0,
                type_str: "ObjectId".into(),
                coverage: 1.00,
                samples: vec!["ObjectId(…)".into()],
            },
            SchemaField {
                name: "userId".into(),
                depth: 0,
            ...
            SchemaField {
                name: "total".into(),
                depth: 0,
                type_str: "Decimal".into(),
                coverage: 1.00,
                samples: vec!["49.00".into(), "312.40".into()],
            },
            SchemaField {
                name: "status".into(),
                depth: 0,
                type_str: "enum".into(),
                coverage: 1.00,
                samples: vec!["paid".into(), "pending".into(), "shipped".into()],
            },
            SchemaField {
                name: "items".into(),
                depth: 0,
                type_str: "Array<Doc>".into(),
                coverage: 1.00,
                samples: vec!["[{…}, {…}]".into()],
            },
            SchemaField {
            ...
            SchemaField {
                ...
                type_str: "Doc".into(),
                coverage: 0.96,
                samples: vec!["{ country, city, … }".into()],
            },
            SchemaField {
                name: "shipping.country".into(),
                depth: 1,
                type_str: "String".into(),
                coverage: 0.96,
                samples: vec!["US".into(), "DE".into(), "JP".into()],
            },
            SchemaField {
                name: "coupon".into(),
                depth: 0,
